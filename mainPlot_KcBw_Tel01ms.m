...
figName = 'Fig_Save\KcBw_Chi_Tel01';
YLimKc = [0.1 10];
YLimBW = [0.9e3 3e4];
...
% Tnc = Tel = 1ms
filename = '5_Tel0.1ms_Tnc0.1ms_2.csv';
SZTel1 = importfile2(filename);

% Tnc = Tel = 5ms
filename = '9_Tel0.1ms_Tnc0.12ms_2.csv';
SZTel5 = importfile2(filename);

% Tnc = Tel = 10ms
filename = '13_Tel0.1ms_Tnc0.14ms_2.csv';
...
str = ['PI Current control in continuous domain and discrete domain when Tel = 0.1ms'];
...
% common legend
leg_text = {'Tnc = 0.8Tel [s]';'Tnc = 0.8Tel [z]';'Tnc = 1Tel [s]';'Tnc = 1Tel [z]';...
    'Tnc = 1.2Tel [s]';'Tnc = 1.2Tel [z]';'Tnc = 1.4Tel [s]';'Tnc = 1.4Tel [z]'};
