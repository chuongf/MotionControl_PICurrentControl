...
figName = 'Fig_Save\KcBw_Chi_Tel10';
YLimKc = [10 1000];
YLimBW = [0.9e3 3e4];
...
% Tnc = Tel = 1ms
filename = '8_Tel10ms_Tnc10ms_2.csv';
SZTel1 = importfile2(filename);

% Tnc = Tel = 5ms
filename = '12_Tel10ms_Tnc12ms_2.csv';
SZTel5 = importfile2(filename);

% Tnc = Tel = 10ms
filename = '16_Tel10ms_Tnc14ms_2.csv';
...
str = ['PI Current control in continuous domain and discrete domain when Tel = 10ms'];
