...
figName = 'Fig_Save\KcBw_Chi_Tel1';
YLimKc = [1 100];
YLimBW = [0.9e3 3e4];
...
% Tnc = Tel = 1ms
filename = '6_Tel1ms_Tnc1ms_2.csv';
SZTel1 = importfile2(filename);

% Tnc = Tel = 5ms
filename = '10_Tel1ms_Tnc1.2ms_2.csv';
SZTel5 = importfile2(filename);

% Tnc = Tel = 10ms
filename = '14_Tel1ms_Tnc1.4ms_2.csv';
...
str = ['PI Current control in continuous domain and discrete domain when Tel = 1ms'];
