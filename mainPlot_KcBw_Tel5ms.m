...
figName = 'Fig_Save\KcBw_Chi_Tel5';
YLimKc = [10 500];
YLimBW = [0.9e3 3e4];
...
% Tnc = Tel = 1ms
filename = '7_Tel5ms_Tnc5ms_2.csv';
SZTel1 = importfile2(filename);

% Tnc = Tel = 5ms
filename = '11_Tel5ms_Tnc6ms_2.csv';
SZTel5 = importfile2(filename);

% Tnc = Tel = 10ms
filename = '15_Tel5ms_Tnc7ms_2.csv';
...
str = ['PI Current control in continuous domain and discrete domain when Tel = 5ms'];
